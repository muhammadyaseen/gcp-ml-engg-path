...
![[Pasted image 20230208163146.png]]
![[Pasted image 20230208163752.png]]
![[Pasted image 20230208163853.png]]
...
Once the image has been build it will be avaibale in the Container Registery. The true power of custom build configuration files (like YAML) is their ability to perform other actions, in parallel or in sequence, in addition to simply building containers: running tests on your newly built containers, pushing them to various destinations, and even deploying them to Kubernetes Engine. So it can act as a CD system.
...
![[Pasted image 20230209135844.png]]
...
![[Pasted image 20230209140353.png]]
...
![[Pasted image 20230209142408.png]]
...
![[Pasted image 20230209143532.png]]
...
Canary Deployments
![[Pasted image 20230209160859.png]]
...
![[Pasted image 20230223133008.png]]

![[Pasted image 20230223133053.png]]
![[Pasted image 20230223133112.png]]
![[Pasted image 20230223133132.png]]

## Intro to AI Platform Pipelines
![[Pasted image 20230223133350.png]]
...
![[Pasted image 20230223133735.png]]

![[Pasted image 20230223134017.png]]
...
## AIP Pipelines: Concepts

Tech stack behind pipelines. TFX is focused on TensorFlow while Kubeflow is generic.

![[Pasted image 20230223134819.png]]

## When to use
![[Pasted image 20230223140305.png]]
![[Pasted image 20230223140408.png]]
## Ecosystem

![[Pasted image 20230223140550.png]]

# Training, Tuning, and Serving on AI Platform
## System and Concept Overview
![[Pasted image 20230224162605.png]]
...
![[Pasted image 20230224165115.png]]
...
![[Pasted image 20230224165230.png]]

from command line.. create a split
![[Pasted image 20230224165307.png]]
... then store result in Cloud Storage
![[Pasted image 20230224165434.png]]
...
![[Pasted image 20230224182523.png]]
![[Pasted image 20230224182538.png]]
![[Pasted image 20230224182556.png]]
![[Pasted image 20230224182610.png]]
...
The docker file is shown in the image following. Any additional arguments passed to the command that executes the container run command will be forwarded to the `ENTRYPOINT` command as command line arguments. That's how you pass the hyperparameter values, to our training container.
...
![[Pasted image 20230224182901.png]]
...
![[Pasted image 20230224195414.png]]
...
![[Pasted image 20230224195440.png]]
...
SDK method:
![[Pasted image 20230224195610.png]]
...
![[Pasted image 20230224195706.png]]
...
![[Pasted image 20230224200233.png]]
...
![[Pasted image 20230224200305.png]]
...
![[Pasted image 20230224200400.png]]
## Lab
...
![[Pasted image 20230221185055.png]]
![[Pasted image 20230221185145.png]]
...
![[Pasted image 20230221191200.png]]
...
![[Pasted image 20230221203144.png]]
We can init the components as follows. 
![[Pasted image 20230221203355.png]]
...
![[Pasted image 20230221203526.png]]
...
![[Pasted image 20230221205443.png]]
Now they can be used like normal components
![[Pasted image 20230221205628.png]]
...
![[Pasted image 20230221205840.png]]
...
![[Pasted image 20230222183814.png]]
...
![[Pasted image 20230222185001.png]]
...
![[Pasted image 20230222185018.png]]
![[Pasted image 20230222185103.png]]
![[Pasted image 20230222185123.png]]
